    ...
    <div className="relative">
      ...
      <div className="bg-white pr-6 pl-6 pt-2 pb-2 shadow-md">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center">
            ...
            <a href="#" className="ml-4 text-gray-600 hover:text-gray-900">Register</a>
      ...
      <header className="relative bg-cover bg-center h-[80vh]" style={{ backgroundImage: "url('images/hero-bg.jpg')" }}>
        ...
        {/* Left-aligned Content */}
          ...
          <div className="relative z-10 flex flex-col items-start justify-center h-full text-left text-white px-12 max-w-[600px]">
